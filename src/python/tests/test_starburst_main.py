...
class TestStarburst99(unittest.TestCase):
    ...
    @patch('starburst_main.Starburst99._read_tracks')
    @patch('starburst_main.Starburst99._write_output')
    @patch('starburst_main.Starburst99._main_calculation_loop')
    ...
    @patch('starburst_main.Starburst99.run')
    ...
    @patch('starburst_main.Starburst99.run')
    def test_main_with_input_file(self, mock_run):
