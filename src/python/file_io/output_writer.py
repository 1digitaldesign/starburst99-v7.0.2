...
class OutputWriter:
    ...
    def write_all_outputs(self, galaxy: GalaxyModel):
        ...
        """
        # Use output prefix if set, otherwise sanitize the model name
        base_name = galaxy.model_params.output_prefix
        if not base_name or base_name == 'model':
        ...
        summary = {
            ...
            "parameters": {
                ...
                "tracks": {
                    ...
                    "wind_id": galaxy.model_params.wind_id
                }
            },
            "results": {
